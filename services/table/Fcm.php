...
class Fcm extends REST{
	...
	public function sendNotif(){
		...
		$title = $this->_request['judul'];
		$body = $this->_request['body'];

		$ar = array('token'=>$token,'judul'=>$title,'isi'=>$body);
		$this->show_response($ar);
		// $url = "https://fcm.googleapis.com/fcm/send";
		// $serverKey = $this->conf->FCM_KEY;
	 ...
	 //    $result_data = json_decode($result);
		...
		// $result_arr['token'] = json_decode($token);

		// $result_arr['body'] = json_decode($body);

		// $result_arr['title'] = json_decode($title);
	...
	public function sendWarn(){
	    ...
	    $token = "dN8S7Vl-k8A:APA91bGVPhjSbxnSy4HOz2L1sS4zp3WWqIqB1Zg68piVePrWzl9okUtYx74VlTPowVTVUQLLxyEEqdtBiVOE0YE_ugPQmf_IAK0ZgcZxTW0SChWvyTxdjsD7y66YnvO2cNqELOvMEl_6";
